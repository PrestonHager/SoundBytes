  ...
  async connect(options) {
    ...
    this.connection.onclose = (closeEvent) => {
      ...
      if (closeEvent.code === 1001) {
        ...
        // 1000 is the equivalent of 200 in HTTP
        // if close code is not 1000, then something went wrong
        throw new Error(
          `WebSocket Connection closed with code ${closeEvent.code} because ${closeEvent.reason}`
        )
      }
